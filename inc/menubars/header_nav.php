                ...
                <?php endif; ?>
                    <div class="extension-nav">
                        ...
                        <?php if ( get_theme_mod( 'social_icon_setting' ) === 'yes' ) {
                            ...
                            $starter_customizer_repeater = get_theme_mod('starter_customizer_repeater', json_encode( array()) );
                            /*decoding json data*/
                            $customizer_repeater_example_decoded = json_decode($starter_customizer_repeater);
                    ...
                    <?php  }  ?>
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu">
                            ...
                            <?php if ( has_custom_logo() ): 
                                ...
                                $logourl = wp_get_attachment_image_src( $custom_logo_id , 'starter-logo' ); 
                            ?>
